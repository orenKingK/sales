...
export class BrandsService {
  ...
  async getBrands(): Promise<Brand[]> {
    // Dynamically update Zara count
    const zaraBrand = this.brands.find(b => b.name === 'זארה');
    if (zaraBrand) {
      try {
        const filePath = path.join(process.cwd(), 'src/zara/zara2.json');
        const fileContent = await fs.readFile(filePath, 'utf-8');
        const zaraData = JSON.parse(fileContent);
        // We only need the length. To avoid breaking the UI which expected products.length,
        // we can either return empty objects of that length or better yet, update the Brand interface
        // to have a count, but the current UI uses .length.
        // For now, let's just make the products array have the correct length.
        zaraBrand.products = new Array(zaraData.length).fill({});
      } catch (e) {
        console.error('Error updating Zara count in BrandsService', e);
      }
    }
    return this.brands;
  }
  ...
  private initializeData() {
    // Ported from client dummyData.ts
    const generateProducts = (brandPrefix: string, category: string): Product[] => {
        ...
        const images: Record<string, string[]> = {
            'Fashion': [
                ...
                'https://images.unsplash.com/photo-1551488852-080175b25299?w=800&q=80',
                'https://images.unsplash.com/photo-1604176354204-9268737828fa?w=800&q=80',
            ],
            'Electronics': [
                'https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?w=800&q=80',
                'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=800&q=80',
                'https://images.unsplash.com/photo-1588872657578-a83a04a3a5f9?w=800&q=80',
                'https://images.unsplash.com/photo-1593642702821-c8da6771f0c6?w=800&q=80',
                'https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=800&q=80',
                'https://images.unsplash.com/photo-1593305841991-05c2e439ee60?w=800&q=80',
            ...
            'Lingerie': [
                ...
                'https://images.unsplash.com/photo-1509319117193-518cd388C8e3?w=800&q=80',
                'https://images.unsplash.com/photo-1571781564883-8a0b0d3e239e?w=800&q=80',
            ...
            'Cosmetics': [
                ...
                'https://images.unsplash.com/photo-1580870308373-1cb58de779eb?w=800&q=80',
                'https://images.unsplash.com/photo-1522335789203-abd652321218?w=800&q=80',
            ],
             'Body': [
                'https://images.unsplash.com/photo-1547887538-e6a0d2f8da3d?w=800&q=80',
                ...
                'https://images.unsplash.com/photo-1556228720-1927cbdf4650?w=800&q=80',
            ]
        };
    
        const categoryImages = images[category] || images['Fashion'];
        ...
        const categoryNames = names[category] || names['Fashion'];
    ...
    this.brands = [
        {
            ...
            category: 'אופנה',
            products: [] // Zara products are fetched via ZaraService, but we can leave empty here for now or handle in controller
        },
        {
            id: '2',
            name: 'KSP',
